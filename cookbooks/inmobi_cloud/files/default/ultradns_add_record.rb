...
#      [ -a | --address ADDRESS ] The IP address to set for this DNS
#      record. (Default: private) 
#      [ -h | --help ] 
# 
# == Author 
# Shanker Balan, InMobi Inc
# 
# == Copyright 
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:v01="http://webservice.api.ultra.neustar.com/v01/" xmlns:v011="http://schema.ultraservice.neustar.com/v01/">
  ...
  <soapenv:Body>
    <v01:createResourceRecord>
      ...
      <resourceRecord ZoneName="#{zone_id}." Type="1" DName="#{hostname}." TTL="3600">
...
5.times do
  result = `curl -s -H 'Content-Type: text/xml;charset=UTF-8' -d @#{cmd_filename} '#{ultra_url}'`
