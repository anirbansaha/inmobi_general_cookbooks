...
recipe "inmobi_cloud::ebs_create_attach_test", "Creates ebs volumes and attaches to the instance based on the inputs entered, i.e. number of volumes required and size of each volume"
...
attribute "inmobi_cloud/rs_hostname",
 ...
 :required => "required",
 :recipes => [ "inmobi_cloud::base_os_config", "inmobi_cloud::apt_repo_config", "inmobi_cloud::dns_add_record", "inmobi_cloud::dns_delete_record", "inmobi_cloud::hostname_change_config", "inmobi_cloud::ebs_create_attach", "inmobi_cloud::ebs_create_attach_test" ]
...
attribute "inmobi_cloud/availability_zone",
 ...
 :required => "required",
 :recipes => [ "inmobi_cloud::base_os_config", "inmobi_cloud::hostname_change_config", "inmobi_cloud::ebs_create_attach", "inmobi_cloud::ebs_create_attach_test" ]
...
attribute "inmobi_cloud/rscale_username",
 ...
 :required => "required",
 :recipes => [ "inmobi_cloud::ebs_create_attach", "inmobi_cloud::ebs_create_attach_test" ]
